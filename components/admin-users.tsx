              ...
              {[...Array(2)].map((_, i) => (
                <div key={i} className="flex items-center justify-between gap-4 rounded-lg border p-3">
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="h-3 bg-muted shimmer-gradient rounded w-1/3"></div>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-36 bg-muted shimmer-gradient rounded"></div>
                    <div className="h-8 w-10 bg-muted shimmer-gradient rounded"></div>
                  </div>
                </div>
              ))}
            </div>
